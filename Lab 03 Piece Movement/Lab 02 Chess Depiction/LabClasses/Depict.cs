...
namespace Chess
{
    public class Depict
    {
        ...
        public void AddMovement(string piece, string color, string oldRank, string oldFile, string newRank, string newFile, string action)
        {
            ...
            LabClasses.PieceMovement checkMove = new LabClasses.PieceMovement();

            if (checkMove.CheckMovement(piece, color, parsedOldFile, parsedOldRank, parsedNewFile, parsedNewRank, action))
            {
